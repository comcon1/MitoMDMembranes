...
#    cmd.color("marine", "resname BTL")
    cmd.show_as("sticks", "mito_lipids")
    cmd.select("lipids_H", "hydro and (resname POPC or resname SLPE or resname PLPC)")
...
#    cmd.select("perox_o", "name OP* and tlx")
    cmd.select("oxy", "name O* and mito_lipids")
    cmd.select("phos", "name P* and mito_lipids")
