...
CONNECT_BARRIER = 0.2   # the maximal distance for attribution of atoms to the rotating 
                         # or stayin group: to increase if "atom numbers do not cover the 
                         # molecule", to decrease if "trying to rotate cycle molecule"
